...
**ONLY for Editorial Illustration or Hybrid mode.** If the user chose Information Graphic, SKIP this phase entirely — use the JasAI brand system (hard shadows, cream background, accent colors).
...
if [ ! -f .env ]; then
  cat > .env <<'EOF'
# JasAI Skills - API Keys Configuration
...
9. TECHNICAL
   "Footer at the very bottom in small, clean sans-serif: 'Jaspreet Singh | Founder @ VividAutomate'"
...
Always include: `"Jaspreet Singh | Founder @ VividAutomate"`
...
12. **Always include footer** — "Jaspreet Singh | Founder @ VividAutomate"
