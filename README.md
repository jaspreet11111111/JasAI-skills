...
```bash
# Add marketplace
/plugin marketplace add jaspreetsingh/jasai-skills

# Install a department plugin
/plugin install marketing@jasai-skills
/plugin install sales@jasai-skills
/plugin install operations@jasai-skills
/plugin install creative@jasai-skills
/plugin install product@jasai-skills
/plugin install youtube@jasai-skills
```
...
```bash
# Quick setup
curl -O https://raw.githubusercontent.com/jaspreetsingh/jasai-skills/main/.env.example
mv .env.example .env
...
- `jasai-skills-marketplace.zip` (all departments in one package)
